...
E.g. ``__future__``, Python libraries, 3rd party libraries, discord.py imports, pumpkin.py imports; all separated with one empty line.
...
The ``setup()`` function for discord.py MUST be the last thing declared in the file.
